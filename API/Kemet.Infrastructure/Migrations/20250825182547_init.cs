        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GovernorateDeliveryId = table.Column<int>(type: "integer", nullable: true),
                    ProductQuantityPriceId = table.Column<int>(type: "integer", nullable: false),
                    ProductId = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CodeFromDeliveryCompany = table.Column<string>(type: "text", nullable: true),
                    Note = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.GovernorateDeliveryId,
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "OrderReceiptStatusId", "Name" },
                values: new object[,]
                {
                    { 1, "تم الاستلام بالكامل" },
                    { 2, "تم الاستلام جزئيًا" },
                    { 3, "تم رفض الاستلام" },
                    { 4, "فشل محاولة التسليم" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Order is pending.", "معلق" },
                    { 2, "Order is being processed.", "جارى المعالجة" },
                    { 3, "Order has been shipped.", "تم الشحن" },
                    { 4, "Order has been delivered.", "تم التوصيل" },
                    { 5, "Order has been cancelled by customer.", "تم الإلغاء من قبل العميل" },
                    { 6, "Order has been cancelled by admin.", "تم الإلغاء من قبل الإدارة" },
                    { 7, "Order has been refunded.", "تم استرداد المبلغ" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "المندوب استلم المنتجات المرتجعة.", "عند شركة الشحن" },
                    { 2, "شركة الشحن في طريقها لإرجاع المنتجات.", "في الطريق" },
                    { 3, "تم استلام المنتجات فعليًا في مكان العمل.", "تم الاستلام" },
                    { 4, "يتم الآن فحص حالة المنتج المرتجع.", "قيد الفحص" },
                    { 5, "تم إرجاع المنتج إلى المخزون.", "تمت إعادة التخزين" },
                    { 6, "تم إتلاف المنتج المرتجع.", "تم الإتلاف" },
                    { 7, "تم فقدان المنتج المرتجع.", "فُقد" }
                });
