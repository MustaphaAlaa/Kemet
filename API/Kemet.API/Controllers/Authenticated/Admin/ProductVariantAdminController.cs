...
[Route("api/a/productVariant")]
[ApiController]
[Authorize(Roles = "Admin")]
public class ProductVariantAdminController : ControllerBase
{
    private ILogger<ProductVariantAdminController> _logger;
    ...
    public ProductVariantAdminController(
        ILogger<ProductVariantAdminController> logger,
    ...
    public async Task<IActionResult> UpdateProductVarientStock(
    ...
    )
    {
        ...
        {
            _logger.LogInformation(
                $"ProductVariantController => UpdateProductVarientStock({productVariantId},   {stockQuantity})"
            );
            var productVariants = await _productVariantService.UpdateStock(
                productVariantId,
                stockQuantity
            );
