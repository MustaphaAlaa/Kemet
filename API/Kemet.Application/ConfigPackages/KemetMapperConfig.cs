...
public class KemetMapperConfig : Profile
{
    public KemetMapperConfig()
    {
        ...
        CreateMap<OrderStatusReadDTO, OrderStatus>().ReverseMap();
        CreateMap<OrderReceiptStatusReadDTO, OrderReceiptStatus>().ReverseMap();
        ...
        //UnitPrice
        CreateMap<PriceCreateDTO, Price>().ReverseMap();
        ...
        CreateMap<ProductQuantityPriceCreateDTO, ProductQuantityPrice>().ReverseMap();
        ...
        CreateMap<ProductQuantityPriceUpdateDTO, ProductPriceOrchestratorDTO>().ReverseMap();
        ...
        //Delivery Company
        CreateMap<DeliveryCompanyCreateDTO, DeliveryCompany>().ReverseMap();
        ...
        CreateMap<GovernorateDeliveryCompanyCreateDTO, GovernorateDeliveryCompany>().ReverseMap();
        ...
        // GovernorateDelivery
        CreateMap<GovernorateDeliveryCreateDTO, GovernorateDelivery>().ReverseMap();
