...
public class CustomerEmployeesController : ControllerBase
{
    ...
    public CustomerEmployeesController(ILogger<CustomerEmployeesController> logger, ICustomerService customerService)
    {
        _logger = logger;
    ...
    public async Task<IActionResult> Customer(string phoneNumber)
    {
        try
        {
            ...
            _response.IsSuccess = true;
            _response.StatusCode = customer is not null ? HttpStatusCode.OK : HttpStatusCode.NotFound;
