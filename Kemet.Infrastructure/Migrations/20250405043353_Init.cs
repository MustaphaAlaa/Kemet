    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Colors",
                columns: new[] { "ColorId", "Hexacode", "NameAr", "NameEn" },
                values: new object[,]
                {
                    { 1, "#000000", "اسود", "Black" },
                    { 2, "#000080", "كحلى", "Navy" },
                    { 3, "#654321", "بنى غامق", "Dark Brown" },
                    { 4, "#A9A9A9", "رمادى غامق", "Drak Grey" },
                    { 5, "#808000", "زيتونى", "Olive" },
                    { 6, "#C0C0C0", "فضي", "Sliver" },
                    { 7, "#C19A6B", "جملي", "Camel / Light Brown" },
                    { 8, "#F5F5DC", "بيج", "Beige" }
                });
